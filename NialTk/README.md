...
shell and writes to the Tcl process over it's standard input. Communication back from Tcl to Nial is over a socket connection using a simple character oriented protocol (*tclconnector.tcl*) which is loaded at the beginning of the interaction.
